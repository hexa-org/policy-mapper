...
func (p *policyStoreSvc) GetResourceRoles() ([]rar.ResourceActionRoles, error) {
...
func (p *policyStoreSvc) UpdateResourceRole(rar rar.ResourceActionRoles) error {
...
func toResourceActionRoleList(items []resourcePolicyItem) ([]rar.ResourceActionRoles, error) {
...
func (item resourcePolicyItem) toResourceActionRole() (rar.ResourceActionRoles, error) {
	...
	return rar.NewResourceActionRoles(item.Resource, item.Action, members), nil
}
