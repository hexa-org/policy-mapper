...
type ApimNamedValueSvc interface {
	GetResourceRoles(s armmodel.ApimServiceInfo) ([]rar.ResourceActionRoles, error)
	UpdateResourceRole(s armmodel.ApimServiceInfo, nv rar.ResourceActionRoles) error
}
...
func (svc *apimNamedValueSvc) GetResourceRoles(s armmodel.ApimServiceInfo) ([]rar.ResourceActionRoles, error) {
...
func (svc *apimNamedValueSvc) UpdateResourceRole(s armmodel.ApimServiceInfo, nv rar.ResourceActionRoles) error {
...
func apimResourceRolesMapper() func(page azarmapim.NamedValueClientListByServiceResponse) []rar.ResourceActionRoles {
	return func(page azarmapim.NamedValueClientListByServiceResponse) []rar.ResourceActionRoles {
		...
		for _, nv := range page.Value {
			...
			one := rar.NewResourceActionRolesFromProviderValue(*nv.Name, roles)
