...
func TestUpdateResourceRole_ValidationErrors(t *testing.T) {
	...
	err := svc.UpdateResourceRole(serviceInfo, rar.ResourceActionRoles{})
	assert.Error(t, err)
...
func TestUpdateResourceRole_Error(t *testing.T) {
	...
	existingNV := rar.NewResourceActionUriRoles("/humanresources", http.MethodGet, []string{""})
...
func TestUpdateResourceRole_Success(t *testing.T) {
	...
	updatedNV := rar.NewResourceActionUriRoles("/humanresources", http.MethodGet, []string{"GetHRRole"})
...
func makeNVClientResp(nv rar.ResourceActionRoles) azarmapim.NamedValueClientUpdateResponse {
	nvName := nv.Name()
	nvVal := nv.Value()
...
func makeNVClientUpdateParam(updatedNv rar.ResourceActionRoles) azarmapim.NamedValueUpdateParameters {
