                ...
                case ']':
                    ...
                    if valPathCnt == 0 {
                        ...
                        if charPos+1 < len(expression) && expRunes[charPos+1] != ' ' {
                            return nil, errors.New("invalid IDQL idqlCondition: expecting space after ']' in value path expression")
                            /*
                            	charPos++
...
func createExpression(attribute string, cond string, value string) (AttributeExpression, error) {
    ...
    default:
        return AttributeExpression{}, errors.New("invalid IDQL idqlCondition: Unsupported comparison operator: " + cond)
    }
