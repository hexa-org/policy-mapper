...
func IntegrationInfo(providerType string) policyprovider.IntegrationInfo {
	return policyprovider.IntegrationInfo{Name: providerType, Key: AwsCredentialsForTest()}
}
