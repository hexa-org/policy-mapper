...
func NewMockHttpClientWithJwt(jwksUrl string, issuer string, aud string, scopes []string) (*MockHTTPClient, error) {
    os.Setenv(oauth2support.EnvOAuthJwksUrl, jwksUrl)
    os.Setenv(oauth2support.EnvJwtRealm, "test")
    os.Setenv(oauth2support.EnvJwtAudience, aud)
    os.Setenv(oauth2support.EnvJwtKid, issuer)
    os.Setenv(oauth2support.EnvJwtAuth, "true")
