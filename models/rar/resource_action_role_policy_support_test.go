...
func TestCalcResourceActionRolesForUpdate_NoUpdates(t *testing.T) {
	act := rar.CalcResourceActionRolesForUpdate(nil, nil)
	assert.Empty(t, act)

	act = rar.CalcResourceActionRolesForUpdate(
...
func TestCalcResourceActionRolesForUpdate_RemoveOneAddOne(t *testing.T) {
	...
	actRars := rar.CalcResourceActionRolesForUpdate(existingRars, inputPolicies)
...
func TestCalcResourceActionRolesForUpdate_RemoveOneAddOne_MulResources(t *testing.T) {
	...
	expResourceToRarMap := map[string]rar.ResourceActionRoles{
		expRes[0]: rar.NewResourceActionRoles(expRes[0], "GET", expRoles),
		expRes[1]: rar.NewResourceActionRoles(expRes[0], "GET", expRoles),
	}
